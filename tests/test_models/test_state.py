...
class TestStateInstantiation(unittest.TestCase):
    ...
    def test_created_at_is_public_datetime(self):
        """Test created_at is a public datetime attribute"""
        self.assertEqual(datetime, type(State().created_at))

    def test_updated_at_is_public_datetime(self):
        """Test updated_at is a public datetime attribute"""
    ...
    def test_two_states_unique_ids(self):
        """Test two state instances have different ids"""
        st1 = State()
        st2 = State()
        self.assertNotEqual(st1.id, st2.id)

    def test_two_states_different_created_at(self):
        """Test two state instances have different created_at times"""
        st1 = State()
        sleep(0.05)
        st2 = State()
    ...
    def test_two_states_different_updated_at(self):
        """Test two state instances have different updated_at times"""
        st1 = State()
        sleep(0.05)
        st2 = State()
